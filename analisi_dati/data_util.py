...
sui file dataset in formato csv. Comandi disponibili:
    ...
    -> python data_util.py retime <target-file>: riscrive la colonna timestamp di un file in modo che la prima acquisizione parta dal tempo 0.
    -> python data_util.py duration <target-file>: legge la durata totale della sessione di acquisizione.
"""
